...
output_dir = '/home/firefly/Denoising-rk3588J/output/20250113_output_pmrid_v1'  # 并行处理输出目录
hef_path = '/home/firefly/Denoising-rk3588J/models/pmrid_v1/pmrid_v1.hef'  # Hailo模型路径
...
def worker_process(device_id, task_queue, result_queue, hef_path):
    ...
    try:
        ...
        while True:
            ...
            output_tensor = output_tensor.astype(np.int16)
            output_tensor = np.clip((output_tensor - 127.5), -20, 20)
            output_tensor += batch_tensor
